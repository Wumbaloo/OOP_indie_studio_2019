...
{
    this->_defaultButtons.push_back(this->newButton(core::rect<s32>(950, 850, 1370, 1010), true, "./assets/images/yesDefault.png"));
    this->_defaultButtons.push_back(this->newButton(core::rect<s32>(500, 850, 920, 1010), true, "./assets/images/noDefault.png"));
    this->_hoverButtons.push_back(this->newButton(core::rect<s32>(950, 850, 1370, 1010), false, "./assets/images/yesHover.png"));
    this->_hoverButtons.push_back(this->newButton(core::rect<s32>(500, 850, 920, 1010), false, "./assets/images/noHover.png"));
}
...
void Load::resetScene(IrrlichtDevice *window, settings_t *settings, InputManager *inputManager)
{
    ...
    if (this->_loadBackground == nullptr)
        exit(84);
    this->createButtons();
    if (settings->isMuted)
        this->_music->muteAll();
